...
class PySPHInstallerBase(DefaultClusterSetup):
     ...
     def _create_env(self, master):
          master.ssh.execute(r"if [ ! -d '/home/pysph/pysph_env' ]; then mkdir '/home/pysph/pysph_env' && virtualenv /home/pysph/pysph_env; fi")
     ...
     def _configure_python(self, node):
          node.ssh.execute("sudo update-alternatives --install /usr/bin/python python /home/pysph/pysph_env/bin/python2.7 1")
