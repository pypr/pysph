"""A class to represent an array of particles.
...
# Python callable functions to test for tag values
...
cdef class ParticleArray:
    ...
    **Notes**
    ...
    # `object` interface
    ######################################################################
    def __cinit__(self, str name='', int index=0, default_particle_tag=Local,
        ...
        index : int
            Index of this particle array in a list of particles
