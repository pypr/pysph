...
There are other examples that use the transport velocity formulation::
    ...
    $ python -m pysph.examples.cavity
...
(2001), 6641-6662::
    ...
    $ python -m pysph.examples.solid_mech.rings
...
try the following::
    ...
    $ OMP_NUM_THREADS=8 python -m pysph.examples.elliptical_drop --openmp
...
like::
    ...
    $ python -m pysph.examples.elliptical_drop --disable-output --openmp
...
of the examples with MPI as follows::
    ...
    $ mpirun -np 4 python -m pysph.examples.dam_break_3d
