# -*- coding: utf-8 -*-
#
# PySPH documentation build configuration file, created by
...
project = u'PySPH'
copyright = u'2013-2018, PySPH developers'
...
latex_documents = [
  ('index', 'PySPH.tex', u'PySPH Documentation',
   u'PySPH developers', 'manual'),
]
...
man_pages = [
    ('index', 'pysph', u'PySPH Documentation',
     [u'PySPH developers'], 1)
]
...
texinfo_documents = [
  ('index', 'PySPH', u'PySPH Documentation',
   u'PySPH developers', 'PySPH', 'One line description of project.',
   'Miscellaneous'),
]
