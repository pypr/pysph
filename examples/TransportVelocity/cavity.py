...
equations = [
    ...
    Group(
        equations=[
            ...
            SolidWallBC(dest='solid', source='fluid', b=1.0, rho0=rho0, p0=p0),
    ...
    Group(
        equations=[
            ...
            MomentumEquation(dest='fluid', source='fluid', nu=nu, pb=p0),
            MomentumEquation(dest='fluid', source='solid', nu=nu, pb=p0),
