"""Rectangular dam break over a dry bed with particle splitting. (65 min)
...
class RectangularDamBreakSplit(Application):
    def add_user_options(self, group):
        ...
        group.add_argument(
            ...
            dest="coeff_A_max", default=1.5, help="Ratio of area of\
