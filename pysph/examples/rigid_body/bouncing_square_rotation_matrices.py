"""Simulating a cube bouncing inside a box with rotational matrices
approach . (24 seconds)
...
from pysph.sph.rigid_body import (
    get_particle_array_rigid_body_rotation_matrix, RigidBodyCollisionSimple,
    SumUpExternalForces, RK2StepRigidBodyRotationMatrices)
...
class BouncingCube(Application):
    def create_particles(self):
        ...
        rad_s = np.ones_like(x) * dx
        tank = get_particle_array_rigid_body_rotation_matrix(
    ...
    def create_solver(self):
        ...
        integrator = EPECIntegrator(body=RK2StepRigidBodyRotationMatrices())
