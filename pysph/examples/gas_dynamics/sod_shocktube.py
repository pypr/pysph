...
class SodShockTube(ShockTubeSetup):
    ...
    def create_particles(self):
        ...
        f, b = self.generate_particles(xmin=self.xmin, xmax=self.xmax,
                                       dxl=self.dxl, dxr=self.dxr, m=self.ml,
                                       pl=self.pl, pr=self.pr, h0=self.h0,
                                       bx=0.00, gamma1=gamma1, ul=self.ul,
                                       ur=self.ur)
