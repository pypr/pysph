...
class SjoGreen(ShockTubeSetup):
    ...
    def create_particles(self):
        ...
        return self.generate_particles(xmin=self.xmin, xmax=self.xmax,
                                       dxl=self.dxl, dxr=self.dxr, m=self.dxl,
                                       pl=self.pl, pr=self.pr, h0=self.h0,
                                       bx=0.03, gamma1=gamma1, ul=self.ul,
                                       ur=self.ur, constants=consts)
    ...
    def create_scheme(self):
        ...
        mpm = GasDScheme(fluids=['fluid'], solids=[], dim=dim, gamma=gamma,
                         kernel_factor=1.5, alpha1=0, alpha2=0, beta=2.0,
