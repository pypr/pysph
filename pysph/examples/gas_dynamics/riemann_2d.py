...
class Riemann2D(Application):
    ...
    def create_particles_constant_volume(self):
        ...
        pa = gpa(name='fluid', x=x, y=y, m=m, rho=rho, h=h, u=u, v=v, p=p, e=e,
                 h0=h.copy())
    ...
    def create_domain(self):
        return DomainManager(xmin=config.xmin, xmax=config.xmax,
    ...
    def create_scheme(self):
        ...
        s = SchemeChooser(default='gsph', gsph=gsph, adke=adke, crksph=crksph,
