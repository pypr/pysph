...
class KHInstability(Application):
    ...
    def create_particles(self):
        ...
        fluid = gpa(name='fluid', x=x, y=y, u=u, v=v, rho=rho, p=p, e=e, m=m,
                    h=h, h0=h)
    ...
    def create_scheme(self):
        crk = CRKSPHScheme(fluids=['fluid'], dim=2, rho0=0, c0=0, nu=0, h0=0,
                           p0=0, gamma=gamma, cl=2, has_ghosts=True)
        ...
        gsph = GSPHScheme(fluids=['fluid'], solids=[], dim=dim, gamma=gamma,
                          kernel_factor=1.5, g1=0.2, g2=0.4, rsolver=2,
        ...
        s = SchemeChooser(default='crksph', crksph=crk, gsph=gsph, adke=adke,
                          mpm=mpm, psph=psph, tsph=tsph)
