...
from pysph.sph.solid_mech.basic import MomentumEquationWithStress2D, HookesDeviatoricStressRate2D,\
    MonaghanArtificialStress, EnergyEquationWithStress2D
        ...
        equations = [
            ...
            Group(
                equations = [
                    ...
                    # momentum equation
                    MomentumEquationWithStress2D(dest='projectile', sources=['projectile','plate',], n=4,wdeltap=self.wdeltap),
                    MomentumEquationWithStress2D(dest='plate',      sources=['projectile','plate',], n=4,wdeltap=self.wdeltap),
                        
                    # energy equation: 
                    EnergyEquationWithStress2D(dest='plate',      sources=['projectile','plate',], 
                                               alpha=avisc_alpha, beta=avisc_beta, eta=avisc_eta),

                    EnergyEquationWithStress2D(dest='projectile', sources=['projectile','plate',], 
                                               alpha=avisc_alpha, beta=avisc_beta,  eta=avisc_eta),
                    ...
                    HookesDeviatoricStressRate2D(dest='plate',      sources=None, shear_mod=G1),
                    HookesDeviatoricStressRate2D(dest='projectile', sources=None, shear_mod=G2),
