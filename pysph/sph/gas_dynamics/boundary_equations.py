...
class TransmissiveBoundary(Equation):
    ...
    def loop(self, d_idx, s_idx, d_p, d_rho, d_e, d_m, d_cs, d_div, d_h, d_u, d_wij, d_htmp,
             s_p, s_rho, s_e, s_m, s_cs, s_h, s_div, s_u, WI):
    ...
    def post_loop(self, d_idx, d_p, d_rho, d_e, d_m, d_cs, d_div, d_u, d_h, d_wij, d_htmp):
